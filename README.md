...
- Remote tab for managing any saved SSH server without leaving the app:
  - **Files** — SFTP browser with breadcrumbs, upload (button or drag-and-drop), download (folders arrive as `.tar.gz`), rename, copy/move, delete, permissions and owner, compress/extract, an in-place text editor, and a follow-the-tail log viewer.
